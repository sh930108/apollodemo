...
public class YamlParser {
    ...
    public static void main(String[] args) throws IOException {
        ...
        properties.load(new FileReader(YamlParser.class.getResource("/").getFile() + "application.properties"));

        //因为Properties类底层继承了Hashtable<Object,Object>类，所以我们可以直接转
        Map<String,Object> map=(Map)properties;


        String yaml = YamlParser.flattenedMapToYaml(map);
        System.out.println(yaml);

        String content = FileUtil.readFileToString(YamlParser.class.getResource("/").getFile() + "configmap.yaml");
